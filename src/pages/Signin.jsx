    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-2xl overflow-hidden transform transition-all duration-500 hover:shadow-3xl">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-indigo-600 p-6 text-white">
          ...
          <p className="text-blue-100 text-center text-sm">Sign in to access your bookings and wallet</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="relative">
              ...
              <div className="relative">
                ...
                />
                <div 
                  className="absolute right-3 top-3 text-gray-400 cursor-pointer hover:text-indigo-500 transition-colors duration-300"
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                type="button"
                className="py-2 px-4 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors duration-200 flex items-center justify-center gap-2"
              >
